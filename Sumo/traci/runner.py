    ...
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        if red_light_time == 2:
            ...
            if(weight < 18 * num_ways/4):
                ...
                print('\nCurrent traffic density: Very less crowded')
            elif (weight < 39 * num_ways/4):
                c_min = 40
                c_max = 20*num_ways
                print('\nCurrent traffic density: Less crowded')
            else:
                c_min = 60
                c_max = 25*num_ways
                print('\nCurrent traffic density: Crowded')
            ...
            if num_ways == 3:       #ngã 3
                ...
                print("Horizontal Weight:", str(horizontal_weight) +'- Time:'+ str(time1), "   Vertical Weight", str(vertical_weight) +'- Time:'+ str(time2))
                ...
                print("Horizontal Weight:", str(horizontal_weight) +'- Time:'+ str(time2), "   Vertical Weight", str(vertical_weight) +'- Time:'+ str(time1))
                ...
                print("Phase 1:", str(image_1_weight) +' - Time 1:'+ str(time1), "Phase 2", str(image_2_weight) +' - Time 2:'+ str(time2), "Phase 3", str(image_3_weight) +' - Time 3:'+ str(time3))
                ...
                print("Phase 1:", str(image_1_weight) +' - Time 1:'+ str(time1), "Phase 2", str(image_2_weight) +' - Time 2:'+ str(time2), "Phase 3", str(image_3_weight) +' - Time 3:'+ str(time3), "Phase 4", str(image_4_weight) +' - Time 4:'+ str(time4))
